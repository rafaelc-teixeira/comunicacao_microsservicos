...
INSERT INTO PRODUCT (ID, NAME, FK_CATEGORY, FK_SUPPLIER, QUANTITY_AVAILABLE) VALUES (2, 'Interestelar', 2, 2, 5);
INSERT INTO PRODUCT (ID, NAME, FK_CATEGORY, FK_SUPPLIER, QUANTITY_AVAILABLE) VALUES (3, 'Harry Potter e a Pedra Filosofal', 3, 2, 3);